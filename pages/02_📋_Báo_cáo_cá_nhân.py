...
def advanced_reports_main():
    """Main personal reports interface for users"""
    st.markdown("# 📊 Báo cáo cá nhân SOULFRIEND")
    st.markdown("#### Phân tích kết quả đánh giá sức khỏe tâm lý của bạn")
    st.markdown("---")
    
    # User info section
    st.info("🔒 **Báo cáo này chỉ hiển thị dữ liệu cá nhân của bạn**")
