...
# Import and use the main admin panel function directly
from components.admin import admin_panel

# Call the main admin panel function (it handles its own authentication)
admin_panel()
...
<div style="text-align: center; color: #6c757d; font-size: 0.9rem;">
    🔧 <strong>SOULFRIEND Admin Panel</strong> | Phiên bản 3.0 | © 2025
</div>
